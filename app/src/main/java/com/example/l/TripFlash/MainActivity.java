...
import com.example.l.TripFlash.view.UserDetailActivity;
import com.example.l.TripFlash.view.SearchCityFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setUpAccountHeader() {
        accountHeader = new AccountHeaderBuilder()
                ...
                .addProfiles(
                        profile,
                        new ProfileSettingDrawerItem().withName("更改账户").withIcon(GoogleMaterial.Icon.gmd_person_add).withIdentifier(100000),
                        new ProfileSettingDrawerItem().withName("管理账户").withIcon(GoogleMaterial.Icon.gmd_settings).withIdentifier(100001)
                )
